...
from ccu_grpc.base_layer_service_pb2 import BautiroDescriptionMessage
...
def start_client():
    ...
    try:
        with insecure_channel(f'{SERVER}:{PORT}') as channel:
            ...
            print('GetBautiroDescription:')
            msg: BautiroDescriptionMessage = stub.GetBautiroDescription(Empty())
            print(msg)
