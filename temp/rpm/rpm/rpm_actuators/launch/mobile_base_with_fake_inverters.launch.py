...
def launch_setup(context, *args, **kwargs):
    ...
    fake_inverters = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution(
            [FindPackageShare("rpm_actuators"), "launch", "fake_inverters.launch.py"])),
        launch_arguments={
            "master_config_package": master_config_package,
            "master_config_directory": master_config_directory,
