...
def generate_launch_description():
    ...
    #     get_package_share_directory('lu_waegele'),
    #     'config', 'xsens_mti_node.yaml')
    # xsens_mti_node = Node(
    #     package='bluespace_ai_xsens_mti_driver',
    #     executable='xsens_mti_node',
    #     name='xsens_mti_node',
    #     namespace='rough/front_left/xsens',
    #     output='screen',
    ...
    ouster_params_declare = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory('lu_waegele'), 'config', 'bautiro_ouster_os0-64.yaml'),
    ...
    # Velodyne all-nodes-launch file for both velodynes.
    # Initial params file and namespaces differ for both drivers

    # # driver_share_dir = get_package_share_directory('velodyne_driver')
    # # adapated config is only necessary for the driver_node
    # vlp16_params_file = Path(
    #     get_package_share_directory('lu_waegele'),
    #     'config', 'bautiro_VLP16-params.yaml')
    # driver_params_file_front_left = Path(
    #     get_package_share_directory('lu_waegele'),
    #     'config', 'bautiro_VLP16_front_left-params.yaml')
    # velodyne_driver_node_front_left = Node(
    #     package='velodyne_driver',
    #     executable='velodyne_driver_node',
    #     namespace='rough/front_left/velodyne',
    #     output='both',
    #     parameters=[vlp16_params_file])

    # driver_params_file_rear_right = Path(
    #   get_package_share_directory('lu_waegele'), 'config',
    #   'bautiro_VLP16_rear_right-params.yaml')
    # velodyne_driver_node_rear_right = Node(
    #     package='velodyne_driver',
    #     executable='velodyne_driver_node',
    #     namespace='rough/rear_right/velodyne',
    #     output='both',
    #     parameters=[vlp16_params_file])

    # # Convert params are the same for both velodynes
    # # for this driver, parse the yaml and replace calibration
    # # flag. Namespace handling needs to be done
    # # when parsing.
    # convert_share_dir = get_package_share_directory('velodyne_pointcloud')
    # # convert_params_file = Path(
    #   convert_share_dir, 'config', 'VLP16-velodyne_convert_node-params.yaml')
    # with open(vlp16_params_file, 'r') as f:
    #     params_dict=yaml.safe_load(f)
    #     convert_params_front_left = \
    #           params_dict['rough/front_left/velodyne']['velodyne_convert_node']['ros__parameters']
    #     convert_params_rear_right = \
    #           params_dict['rough/rear_right/velodyne']['velodyne_convert_node']['ros__parameters']
    #     # print("Front Left:\n{}\nRear Right:\n{}".format(
    # convert_params_front_left, convert_params_rear_right))
    # convert_params_front_left['calibration'] = \
    #   os.path.join(convert_share_dir, 'params', 'VLP16db.yaml')
    # convert_params_rear_right['calibration'] = \
    #   os.path.join(convert_share_dir, 'params', 'VLP16db.yaml')
    # velodyne_convert_node_front_left = Node(
    #     package='velodyne_pointcloud',
    #     executable='velodyne_convert_node',
    #     namespace='rough/front_left/velodyne',
    #     output='both',
    #     parameters=[convert_params_front_left])
    # velodyne_convert_node_rear_right = Node(
    #     package='velodyne_pointcloud',
    #     executable='velodyne_convert_node',
    #     namespace='rough/rear_right/velodyne',
    #     output='both',
    #     parameters=[convert_params_rear_right])

    # # Laserscan params are the same for both velodynes
    # # laserscan_share_dir = get_package_share_directory('velodyne_laserscan')
    # # laserscan_params_file = Path(laserscan_share_dir, 'config',
    # 'default-velodyne_laserscan_node-params.yaml')
    # velodyne_laserscan_node_front_left = Node(
    #     package='velodyne_laserscan',
    #     executable='velodyne_laserscan_node',
    #     namespace='rough/front_left/velodyne',
    #     output='both',
    #     parameters=[vlp16_params_file])
    # velodyne_laserscan_node_rear_right = Node(
    #     package='velodyne_laserscan',
    #     executable='velodyne_laserscan_node',
    #     namespace='rough/rear_right/velodyne',
    #     output='both',
    ...
    # ld.add_action(sick_front_left_node)
    # ld.add_action(sick_rear_right_node)
    ...
    # ld.add_action(velodyne_driver_node_front_left)
    # ld.add_action(velodyne_convert_node_front_left)
    # ld.add_action(velodyne_laserscan_node_front_left)
    # ld.add_action(velodyne_driver_node_rear_right)
    # ld.add_action(velodyne_convert_node_rear_right)
    # ld.add_action(velodyne_laserscan_node_rear_right)
