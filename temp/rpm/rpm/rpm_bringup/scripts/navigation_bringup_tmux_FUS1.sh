...
WS=/bautiro_environment/bautiro_setup_428.bash # modify this when working in local workspace
...
tmux send-keys -t ${WINDOW_CCU}.0 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch bautiro_bringup bautiro_description.launch.py robot_name:=FUS1 rpm_name:=RPM1" Enter
...
tmux send-keys -t ${WINDOW_RPM}.0 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_sensors rpm_sensors_launch.py mode:=real hw_sample:=RPM1 config_file_with_path:=/bautiro_environment/bautiro_core_develop/rpm/install/rpm_sensors/share/rpm_sensors/config/RPM1/rpm_config.yaml" Enter
tmux send-keys -t ${WINDOW_RPM}.1 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_localization rpm_localization_launch.py mode:=real hw_sample:=RPM1 map:=/bautiro_environment/428_bautiro_core/rpm/install/lu_rough_localization/share/lu_rough_localization/maps/rosbag_le131_AUTOMATED_GEN" Enter
...
tmux send-keys -t ${WINDOW_RPM}.5 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_control rpm_diffdrive_controller_launch.py robot_name:=FUS1 rpm_name:=RPM1" Enter
...
# put command to panes
tmux send-keys -t ${WINDOW_RPM2}.0 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_nav2 navigation_launch.py velocity_command_topic:=/rpm/diff_base_controller/cmd_vel_unstamped" #Enter
...
#tmux send-keys -t ${WINDOW}.3 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_control rpm_diffdrive_controller_orig_launch.py robot_name:=FUS2 rpm_name:=RPM2" Enter
...
tmux send-keys -t ${WINDOW}.0 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch bautiro_bringup bautiro_description.launch.py robot_name:=FUS1 rpm_name:=RPM1" Enter
...
tmux send-keys -t ${WINDOW}.2 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_localization rpm_localization_launch.py mode:=real hw_sample:=RPM1 map:=/bautiro_environment/bautiro_core_develop/rpm/install/lu_rough_localization/share/lu_rough_localization/maps/rosbag_le131_AUTOMATED_GEN config_file_with_path:=/bautiro_environment/bautiro_core_develop/rpm/install/rpm_localization/share/rpm_localization/config/RPM1/rpm_config.yaml" Enter
tmux send-keys -t ${WINDOW}.3 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_control rpm_diffdrive_controller_orig_launch.py robot_name:=FUS1 rpm_name:=RPM1" Enter

tmux send-keys -t ${WINDOW}.3 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_nav2 navigation_launch.py" Enter
tmux send-keys -t ${WINDOW}.4 C-z "source ${ROS_PATH} && source ${WS} && ros2 launch rpm_nav2 map_launch.py" Enter
...
#CMD_PATH="bash ${LOCAL_PKG_WORKSPC_PATH}/launch/fus1/"
tmux send-keys -t ${WINDOW}.0 C-z "source /opt/ros/galactic/setup.bash;source /bautiro_environment/bautiro_setup_305.bash;ros2 launch rpm_sensors rpm_sensors_launch.py mode:=real hw_sample:=RPM1 config_file_with_path:=/bautiro_environment/bautiro_core_develop/rpm/install/rpm_sensors/share/rpm_sensors/config/RPM1/rpm_config.yaml" Enter
tmux send-keys -t ${WINDOW}.1 C-z "source /opt/ros/galactic/setup.bash;source /bautiro_environment/bautiro_setup_305.bash;ros2 launch rpm_control rpm_diffdrive_controller_launch.py" Enter
tmux send-keys -t ${WINDOW}.2 C-z "source /opt/ros/galactic/setup.bash;source /bautiro_environment/bautiro_setup_305.bash;ros2 launch rpm_localization rpm_localization_launch.py mode:=real hw_sample:=RPM1 config_file_with_path:=/bautiro_environment/bautiro_core_develop/rpm/install/rpm_localization/share/rpm_localization/config/RPM1/rpm_config.yaml" Enter
tmux send-keys -t ${WINDOW}.3 C-z "source /opt/ros/galactic/setup.bash;source /bautiro_environment/bautiro_setup_305.bash;ros2 launch rpm_nav2 navigation_launch.py" Enter
tmux send-keys -t ${WINDOW}.4 C-z "source /opt/ros/galactic/setup.bash;source /bautiro_environment/bautiro_setup_305.bash;ros2 launch rpm_nav2 map_launch.py" Enter
tmux send-keys -t ${WINDOW}.5 C-z "source /home/bautiro/bautiro_ws/install/setup.bash; ros2 run lu_fein_localization transform_services" Enter
