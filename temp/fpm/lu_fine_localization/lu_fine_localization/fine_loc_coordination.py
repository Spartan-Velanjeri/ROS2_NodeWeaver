...
# service command: ros2 service call /lu_fine_localization bautiro_ros_interfaces/srv/LuFeinLocalization '{in_markers: [data: "1", data: "2", data: "3"]}'
...
from bautiro_ros_interfaces.srv import (LuTsMeasurePoint, LuFineLocalization,
                                        LuTriangulation, LuGetMarkerRoughPosition,LuGetTargetPoseUrFrame)
...
class FeinLocCoordination(Node):
    def __init__(self):
        ...
        # self.fein_loc_coordination_server = self.create_service(LuFeinLocalization, 'lu_fine_localization',
...
def main(args=None):
    ...
    while (lookup_succes):
        ...
        marker_frame_ids = ['1310001','1310009','1310007']
