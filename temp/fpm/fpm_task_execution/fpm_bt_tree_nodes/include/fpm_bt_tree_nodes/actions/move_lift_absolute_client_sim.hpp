...
#ifndef BEHAVIOR_TREE__PLUGINS__ACTION__THIRD_NODE_HPP_SIM_
#define BEHAVIOR_TREE__PLUGINS__ACTION__THIRD_NODE_HPP_SIM_
...
class MoveLiftAbsoluteClientSim : public BT::ActionNodeBase
{
public:
  
  MoveLiftAbsoluteClientSim(
