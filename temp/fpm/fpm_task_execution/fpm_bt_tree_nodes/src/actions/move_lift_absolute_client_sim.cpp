...
#include "fpm_bt_tree_nodes/actions/move_lift_absolute_client_sim.hpp"

namespace fpm_bt_tree_nodes
{

MoveLiftAbsoluteClientSim::MoveLiftAbsoluteClientSim(
...
inline BT::NodeStatus MoveLiftAbsoluteClientSim::tick()
{
  
  
      rclcpp::Node::SharedPtr node_;
      node_ = rclcpp::Node::make_shared("start_action");
      auto action_client = rclcpp_action::create_client<bautiro_ros_interfaces::action::MoveLiftAbsolute>(node_, "/fpm_set_move_lift_absolute");
...
BT_REGISTER_NODES(factory)
{
  ...
  factory.registerNodeType<fpm_bt_tree_nodes::MoveLiftAbsoluteClientSim>("moveliftabsolute_sim");
}