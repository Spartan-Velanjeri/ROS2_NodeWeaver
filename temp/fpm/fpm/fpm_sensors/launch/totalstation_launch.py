...
def generate_launch_description():
    ...
    params_declare = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            ...
            'FPM1', 'ts16_node.yaml'),
        description='Path to the ROS2 parameters file to use for Totalstation Driver.')
    ...
    totalstation_node_name = node_name
    totalstation_node = Node(
        package=driver_package_name,
        executable=executable,
        name=totalstation_node_name,
        namespace=namespace,
        output='screen',
        parameters=[
            {"mode": mode},
    ...
    ld.add_action(totalstation_node)
