...
The setup here is to evalauate a digital 24V-Inupt (provided by the UR-Robot) and send the derived signals via USB-serial
...
#                lastchange = now
	...
	# Reset Counter 
        ...
        if not ptu_ctrl_ramp_state and ptu_ctrl_ramp_state_last:
            # Write new, actualized RPM-setpoint to controller
